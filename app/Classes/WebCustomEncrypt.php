...
class WebCustomEncrypt implements EncrypterContract
{
	 ...
	 * @var string
	 */
	public $encryption_key, $decryption_key;
	...
	public function encrypt($value, $serialize = false)
	{
		...
		$iv = config('app.WEB_API_ENC_VI_KEY');
	...
	public function decrypt($payload, $unserialize = false)
	{
		...
		$iv = config('app.WEB_API_DEC_VI_KEY');
