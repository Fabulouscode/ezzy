...
class AdminMedicineDetaisExport implements FromQuery, WithHeadings, WithColumnFormatting, WithMapping, WithStyles {
    ...
    {
        return ["Id", "Category Name", "Medicine Name", "Medicine SKU", "Medicine Type", "Size / Dosage", "Description", "Quantity", "MRP Price"];
    }
    ...
    public function map($data): array
    {
        return [
            ...
            !empty($data->quantity) ? $data->quantity : '',
            !empty($data->mrp_price) ? $data->mrp_price : '',
        ];
    }
