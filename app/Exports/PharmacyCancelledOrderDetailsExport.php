...
class PharmacyCancelledOrderDetailsExport implements FromQuery, WithHeadings, WithColumnFormatting, WithMapping, WithStyles
{
    ...
    {
        $query = Order::query()->select('orders.*')->with(['clientDetails', 'userDetails'])->where('status','4');
