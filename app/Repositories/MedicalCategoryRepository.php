...
class MedicalCategoryRepository extends Repository
{
    protected $model_name = 'App\Models\Medical_category';
    protected $model;
    ...
    public function getDatatable($request)
    {
        ...
        return Datatables::of($data)
                ...
                {
                    $data = '';
                    if (Auth::user()->hasPermissionTo('medical_category-edit')) {
                    ...
                    if (Auth::user()->hasPermissionTo('medical_category-delete')) {
