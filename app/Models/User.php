...
class User extends Authenticatable
{
    ...
    public function userLocationFormat() {
        return [
            ...
            'clinic_locality' => (!empty($this->userDetails)) ? $this->userDetails->clinic_locality.', '.$this->userDetails->clinic_city.', '.$this->userDetails->clinic_state.', '.$this->userDetails->clinic_country : '',
            'patient_address' => (!empty($this->userPrimaryAddress)) ? $this->userPrimaryAddress->address : '',
