  ...
  public function run()
    {
        ...
        DB::insert("INSERT INTO `states` (`id`, `state_name`, `country_id`) 
                    VALUES
        ...
        DB::insert("INSERT INTO `states` (`id`, `state_name`, `country_id`) 
                    ...
                    (4120, 'Midlands', 246),
                    (4123, 'Makkah Province', 191),
                    (4124, 'Aswan Governorate', 64),
                    (4125, 'Cairo Governorate', 64),
                    (4126, 'Qena Governorate', 64),
                    (4127, 'Al Qassim', 191),
                    (4128, 'Al Jowf', 191),
                    (4129, 'Jizan Province', 191),
                    (4130, 'Al Madinah Province', 191),
                    (4131, 'Riyadh Province', 191),
                    (4132, 'Aseer Province', 191),
                    (4133, 'Ù…Ù†Ø·Ù‚Ø© Ø¹Ø³ÙŠØ±', 191),
                    (4134, 'Ù…ÙƒØ© Ø§Ù„Ù…ÙƒØ±Ù…Ø©', 191),
                    (4135, 'Ciudad de MÃ©xico', 142),
                    (4136, 'Khyber Pakhtunkhwa', 166),
                    (4137, 'Alexandria Governorate', 64),
                    (4138, 'Amman Governorate', 0),
                    (4139, 'Tanger-TÃ©touan-Al HoceÃ¯ma', 148)"
        );
    }
}
