...
Route::namespace('App\Http\Controllers\Api')->group(function(){
   ...
   Route::get('/sms-sending-test', 'UserAuthController@testingFunction');
});
    ...
    Route::middleware(['auth:api','user_block'])->group(function(){
        ...
        Route::prefix('healthcare')->group(function(){            
            ...
            Route::prefix('appointment')->group(function(){     
                ...
                Route::post('/queue/urgent/add', 'AppointmentController@addUrgentAppointmentQueue');
                Route::post('/queue/urgent/accept', 'AppointmentController@acceptAppointmentQueue');
        ...
        Route::prefix('ejabbred')->group(function(){    
            ...
            Route::get('user-last-activity/{user_id?}', 'EjabbredChatController@getLastActivity');
        });
