...
Route::namespace('App\Http\Controllers')->group(function(){
    ...
    Route::prefix('/donotezzycaretouch/')->namespace('Admin')->middleware(['auth:admin','lock'])->group(function(){
        ...
        Route::get('appointment/reviews/is_happy_client/{id?}', 'AppointmentController@isHappyClient')->middleware('role-permission:appointments-review');        
        ...
        Route::post('support_request/chat_msg/update', 'SupportRequestController@updateChatMessage')->middleware('role-permission:support_ticket-edit');
