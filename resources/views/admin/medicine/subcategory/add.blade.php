...
@section('title','Add Medicine Subcategory')
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <h5 class="page-title">Add Medicine Subcategory</h5>
        </div>
    </div>
    <!-- end row -->
                    ...
                    <form method="POST" action="{{ url('donotezzycaretouch/medicine/subcategories') }}" id="medicine_subcategory_form" name="medicine_subcategory_form">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input id="name" required type="text"  class="form-control @error('name') is-invalid @enderror" name="name" value="{{!empty($data->name) ? $data->name : old('name') }}" autocomplete="name" autofocus/>
                                @error('name')
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <a href="{{ url('medicine/subcategories') }}">
