        ...
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <div class="block-options-item mb-3 mr-3 float-right">
                        <a href="javascript:void(0)" onclick="exportAppointmentCompletedExcel()" class="btn d-flex align-items-center btn-info">Export <span id="ajax_loader" class="ml-2"></span></a>
                    </div>
...
<script>
    ...
    var appointment_completed_url = "{{url('/donotezzycaretouch/appointment')}}";
    var data_obj = {};
    var data_status = '5';
    var data_user_id = '';
</script>
