        ...
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <!-- Custom Filter -->
                    <div class="block-options-item mb-3 mr-3 float-right">
                        <a href="javascript:void(0)" onclick="exportAppointmentCancelExcel()" class="btn d-flex align-items-center btn-info">Export <span id="ajax_loader" class="ml-2"></span></a>
                    </div>
