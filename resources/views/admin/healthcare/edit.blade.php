...
@section('title','Edit Health Care Provider Details')
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <h5 class="page-title">Edit Health Care Provider Details</h5>
        </div>
    </div>
    <!-- end row -->
    <div class="row">
                                ...
                                <div class="card-detail-list">
                                    ...
                                    @if($data->category_id == '4')
                                        <div class="row">
                                            ...
                                            <dd class="col-sm-7"> 
                                                <input type="number" required class="form-control" name="userDetails[clinic_consultation_charge]" value="{{$data->userDetails->clinic_consultation_charge}}">
                                            </dd>
                                        </div>
                                        <div class="row">
                                            <dt class="col-sm-5"><label>Home Consultation Fees (per Minute)</label></dt>
                                            <dd class="col-sm-7"> 
                                                <input type="number" required class="form-control" name="userDetails[home_consultation_charge]" value="{{$data->userDetails->home_consultation_charge}}">
                                            </dd>
                                        </div>
                                        <div class="row">
                                    ...
                                    @if($data->category_id == '5' || $data->category_id == '6')
                                        <div class="row">
                                            ...
                                            <dd class="col-sm-7"> 
                                                <input type="number" required class="form-control" name="userDetails[nursing_facility_charge_full_day]" value="{{$data->userDetails->nursing_facility_charge_full_day}}">
                                            </dd>
                                        </div>
                                        <div class="row">
                                            <dt class="col-sm-5"><label>Home Consultation Fees (per Day)</label></dt>
                                            <dd class="col-sm-7"> 
                                                <input type="number" required class="form-control" name="userDetails[nursing_home_visit_charge_full_day]" value="{{$data->userDetails->nursing_home_visit_charge_full_day}}">
                                            </dd>
                                        </div>
                                    @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <dd class="col-sm-7"> 
                                            <input type="file" required class="form-control" name="userDetails[qualification_certificate]" value="{{$data->userDetails->qualification_certificate}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <dd class="col-sm-7"> 
                                            <input type="file" required class="form-control" name="userDetails[practicing_licence]" value="{{$data->userDetails->practicing_licence}}">
