        ...
        <div class="col-sm-12">
            <div class="float-right page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('/donotezzycaretouch/healthcare/user')}}">Health Care Providers</a></li>
                            ...
                            <div class="card-detail-view">
                                ...
                                <div class="card-detail-list">
                                    ...
                                    <div class="row">
                                        ...
                                        <dd class="col-sm-7"> 
                                            <input type="text"  class="form-control" name="userDetails[country]" value="{{$data->userDetails->country}}">
                                        </dd>
                                    </div>
                                    <div class="row">
