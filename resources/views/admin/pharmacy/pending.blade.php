...
@section('title','Pending Pharmacist')
        ...
        <div class="col-sm-12">
            <div class="float-right page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Pending Pharmacist</li>
                </ol>
            </div>
            <h5 class="page-title">Pending Pharmacist</h5>
        </div>
    </div>
    <!-- end row -->
...
<script>
    ...
    var data_obj = {'status':'1', 'category_id':'2', 'provider':'pharmacy'};
</script>
