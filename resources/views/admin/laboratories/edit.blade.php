...
@section('title','Edit Laboratory Details')
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <h5 class="page-title">Edit Laboratory Details</h5>
        </div>
    </div>
    <!-- end row -->
    <div class="row">
                    ...
                    <form method="POST" action="{{ url('donotezzycaretouch/user') }}" id="user_form" name="user_form" enctype="multipart/form-data">
                            ...
                            <div class="card-detail-view">
                                ...
                                <div class="card-detail-list">
                                    ...
                                    <div class="row">
                                        ...
                                        <dd class="col-sm-7">
                                            <input type="text" required class="form-control" name="userDetails[registration_year]" value="{{$data->userDetails->registration_year}}">
                                        </dd>
                                    </div>
                                    <div class="row">
                                        <dt class="col-sm-5"><label>Years of Experience</label></dt>
                                        <dd class="col-sm-7">
                                            <input type="text" readonly required class="form-control" name="userDetails[total_experiance_year]" value="{{$data->userDetails->total_experiance_year}}">
                                        </dd>
                                    </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                @if($data->status == '1')
                                @can('laboratories-approval')
                                <button type="button" class="btn btn-success waves-effect m-l-5" onclick="changeLaboratoriesStatusRow({{$data->id}}, '0')">
