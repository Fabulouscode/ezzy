...
@section('title','Pending Laboratories')
        ...
        <div class="col-sm-12">
            <div class="float-right page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Pending Laboratories</li>
                </ol>
            </div>
            <h5 class="page-title">Pending Laboratories</h5>
        </div>
    </div>
    <!-- end row -->
...
<script>
    ...
    var data_obj = {'status':'1', 'category_id':'3', 'provider':'laboratories'};
</script>
