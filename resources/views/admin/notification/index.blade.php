        ...
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-body"> 
                    ...
                    @endcan                                      
                    <table id="notification_datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Title</th>
